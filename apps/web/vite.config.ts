...
if (!["localhost", "127.0.0.1", "::1"].includes(host))
  throw new Error("CoCo development servers must bind to loopback.");
...
function resolveDevProxyTarget(
  ...
  // server so the renderer and backend share one local origin.
...
// Only this machine may access the development server.
