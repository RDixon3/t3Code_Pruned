...
/**
 * Opens a change request link beside a thread, and says whether it did. Anything else — another
 ...
 *
 * Resolving the project before opening the panel keeps lookalike hostnames as ordinary links.
 * Without a thread or panel, the caller opens the link normally.
 */
