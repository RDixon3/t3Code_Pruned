...
export const OpenInPicker = memo(function OpenInPicker({
  ...
  const effectiveEditors = availableEditors;
  ...
  const openInEditor = useCallback(
    ...
    [environmentId, openInCwd, openInEditorMutation, preferredEditor, remote, setPreferredEditor],
  );
      ...
      <Menu>
        ...
        <MenuPopup align="end">
          {remote.mode === "remote-unavailable" ? (
            <MenuItem disabled>Local environment unavailable</MenuItem>
          ) : (
            <>
