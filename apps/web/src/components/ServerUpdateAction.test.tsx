...
describe("ServerUpdateAction", () => {
  ...
  it("keeps the manual instruction for desktop servers without app update support", () => {
  ...
  it("updates desktop apps through the shared update flow", async () => {
    testState.updateServer.mockResolvedValue(
...
describe("ServerUpdatesAction", () => {
  ...
  const success = AsyncResult.success({ targetVersion: "0.0.31", method: "desktop-app" as const });
