...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["installed cli versions newer available codex claude cursor"],
  },
  {
  ...
  },
  {
    ...
    searchTerms: [
      "agents cli codex claude cursor sign in sign out install subscription instances authentication api key models configuration binary path config directory endpoint arguments environment variables display name accent color custom favorite hidden auto compact",
    ],
  },
  {
    id: "usage-providers",
  ...
  },
  {
    ...
    to: "/settings/connections",
    searchTerms: ["connections local desktop environment status"],
  },
  {
    id: "archive",
