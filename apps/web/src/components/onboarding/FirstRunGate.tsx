...
/**
 * Holds back the authenticated app tree until the first-run decision
...
export function FirstRunGate({
  ...
  // A workspace is still fresh when it contains only the local web server's
  // cwd bootstrap project and thread. Other projects, additional threads, or
  // state from a non-primary backend (such as WSL) are real user state, even
  // when their root path matches the primary cwd.
