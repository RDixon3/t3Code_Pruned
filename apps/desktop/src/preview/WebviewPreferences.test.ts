 ...
 *   strings and assigned to a boolean preference, making values such as
 *   `contextIsolation=no` truthy. The picker now inspects React through its
 *   narrow page-world bridge while the preload remains isolated.
 *
...
describe("PREVIEW_WEBVIEW_PREFERENCES", () => {
  ...
  it("isolates the privileged preload from preview page JavaScript", () => {
