...
const PreviewAutomationEvaluationDetailKind = Schema.Literals([
  "exception-description",
  "exception-text",
  "unknown",
]);
type PreviewAutomationEvaluationDetailKind = typeof PreviewAutomationEvaluationDetailKind.Type;
 ...
 * child inherits guest preferences before Electron can apply popup overrides.
 * Only explicit HTTP(S) URLs create separate popups; other URLs remain in the preview tab.
 *
 ...
 * guest's preferences. Keep the popup explicitly isolated, without the guest's
 * annotation preload. The window keeps the opener and guest session either way.
 */
...
const makeNativeOperations = Effect.fn("PreviewManager.makeOperations")(function* (
  ...
  const elementContextRuntime = yield* Effect.cached(
    fileSystem.readFileString(
      path.join(path.dirname(pictureInPicturePreloadPath), "preview-element-context.iife.js"),
    ),
  );
      ...
      (resume) => {
        ...
        const cleanup = Effect.fn("PreviewManager.cleanupPickElement")(function* () {
          yield* attempt({ operation: "pickElement.cleanup", tabId, webContentsId: wc.id }, () => {
            ...
            wc.ipc.removeHandler(ELEMENT_CONTEXT_CHANNEL);
        ...
        const registerPickElement = Effect.fn("PreviewManager.registerPickElement")(function* () {
          ...
          yield* attempt({ operation: "pickElement.register", tabId, webContentsId: wc.id }, () => {
            wc.ipc.handle(
              ELEMENT_CONTEXT_CHANNEL,
              makeElementContextHandler(
                wc,
                () => runPromise(elementContextRuntime),
                () => !settled,
              ),
            );
...
class PreviewTabNotFoundError extends Schema.TaggedError<PreviewTabNotFoundError>()(
...
class PreviewWebContentsNotFoundError extends Schema.TaggedError<PreviewWebContentsNotFoundError>()(
...
class PreviewWebviewNotInitializedError extends Schema.TaggedError<PreviewWebviewNotInitializedError>()(
...
class PreviewMainWindowClosedError extends Schema.TaggedError<PreviewMainWindowClosedError>()(
...
class PreviewRecordingArmConflictError extends Schema.TaggedError<PreviewRecordingArmConflictError>()(
...
class PreviewRecordingCaptureUnavailableError extends Schema.TaggedError<PreviewRecordingCaptureUnavailableError>()(
...
class PreviewArtifactPathOutsideDirectoryError extends Schema.TaggedError<PreviewArtifactPathOutsideDirectoryError>()(
...
class PreviewArtifactImageLoadError extends Schema.TaggedError<PreviewArtifactImageLoadError>()(
...
class PreviewAutomationDevToolsOpenError extends Schema.TaggedError<PreviewAutomationDevToolsOpenError>()(
...
class PreviewAutomationDebuggerAttachedError extends Schema.TaggedError<PreviewAutomationDebuggerAttachedError>()(
...
class PreviewAutomationTargetNotEditableError extends Schema.TaggedError<PreviewAutomationTargetNotEditableError>()(
...
class PreviewAutomationCoordinatesOutsideViewportError extends Schema.TaggedError<PreviewAutomationCoordinatesOutsideViewportError>()(
...
class PreviewAutomationResultTooLargeError extends Schema.TaggedError<PreviewAutomationResultTooLargeError>()(
...
class PreviewAutomationTimeoutError extends Schema.TaggedError<PreviewAutomationTimeoutError>()(
...
class PreviewAutomationControlInterruptedError extends Schema.TaggedError<PreviewAutomationControlInterruptedError>()(
