...
const ALLOWED_PREVIEW_PERMISSIONS: ReadonlySet<string> = new Set([
  ...
  // Preview content is untrusted, including generated applications. Copy buttons
  // can write to the clipboard; pages cannot read it or request device/location
  // access without a separately designed, user-approved workflow.
