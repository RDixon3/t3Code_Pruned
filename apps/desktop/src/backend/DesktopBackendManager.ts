...
type BackendProcessOutputStream = "stdout" | "stderr";
...
type DesktopBackendBootstrapDelivery = "fd3" | "stdin";
...
class BackendProcessOutputReadError extends Schema.TaggedError<BackendProcessOutputReadError>()(
...
class BackendProcessOutputHandlingError extends Schema.TaggedError<BackendProcessOutputHandlingError>()(
...
class BackendProcessExitStatusError extends Schema.TaggedError<BackendProcessExitStatusError>()(
