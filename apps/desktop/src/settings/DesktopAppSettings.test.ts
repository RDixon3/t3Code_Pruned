...
describe("DesktopSettings", () => {
  ...
  it.effect(
    "ignores removed platform and remote settings without dropping supported settings",
    () =>
      withSettings(
        Effect.gen(function* () {
          const environment = yield* DesktopEnvironment.DesktopEnvironment;
  ...
  it.effect("ignores retired sharing settings without losing local preferences", () =>
    withSettings(
      Effect.gen(function* () {
        const settings = yield* DesktopAppSettings.DesktopAppSettings;
        yield* writeSettingsPatch({
