...
function resolveDesktopRuntimeInfo(processArch: string): DesktopRuntimeInfo {
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "coco-dev" : "coco";
  const legacyUserDataDirName = isDevelopment ? "CoCo (Dev)" : "CoCo (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    runtimeInfo: resolveDesktopRuntimeInfo(input.processArch),
