...
// Packaged CoCo keeps its data separate and seeds the theme only on first use.
if (Electron.app.isPackaged) {
  process.env.T3CODE_HOME = prepareCoCoDataDirectory(NodeOS.homedir(), process.env.T3CODE_HOME);
}
...
// Scheme privileges must be registered before any asynchronous app startup.
