...
interface ProjectSetupScriptRunnerResultNoScript {
  readonly status: "no-script";
}

interface ProjectSetupScriptRunnerResultStarted {
...
class ProjectSetupScriptProjectNotFoundError extends Schema.TaggedError<ProjectSetupScriptProjectNotFoundError>()(
