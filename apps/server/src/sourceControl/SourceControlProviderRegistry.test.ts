...
it.effect("reports GitLab remotes as unavailable without losing their identity", () =>
  Effect.gen(function* () {
    const registry = yield* makeRegistry({
...
it.effect(
  "preserves a caller-selected unknown remote instead of choosing another configured remote",
  () =>
    Effect.gen(function* () {
      const registry = yield* makeRegistry({
...
it.effect("reports Bitbucket remotes as unavailable without losing their identity", () =>
  Effect.gen(function* () {
    const registry = yield* makeRegistry({
