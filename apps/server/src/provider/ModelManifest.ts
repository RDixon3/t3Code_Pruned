/** Bundled provider-model metadata. CoCo never fetches upstream model configuration. */
import {
  ModelCapabilities,
...
interface ResolvedManifestModel {
...
export class ModelManifest extends Context.Service<
  ModelManifest,
  {
    ...
    /** Reuses bundled metadata; provider CLI discovery still supplies live models. */
