...
class TransferHttpRequestError extends Schema.TaggedError<TransferHttpRequestError>()(
...
type CountingWsRpcClient = Effect.Success<typeof makeCountingWsRpcClient>;
