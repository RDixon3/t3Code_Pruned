...
import { AGENT_METHODS, CLIENT_METHODS } from "../../src/_generated/meta.gen.ts";
import * as AcpError from "../../src/errors.ts";
import * as AcpProtocol from "../../src/protocol.ts";
import * as AcpRpcs from "../../src/rpc.ts";
import {
  callRpc,
...
import * as AcpTerminal from "../../src/terminal.ts";
...
>()("effect-acp/test/fixtures/agent/AcpAgent") {}
