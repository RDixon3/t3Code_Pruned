...
/** Reserved for preferences saved by older clients. */
const LEGACY_MOBILE_THEME_ID = "t3-code";
...
/** Legacy preference ids cannot be published as selectable themes. */
export const UNPUBLISHABLE_THEME_IDS: ReadonlySet<string> = new Set([
  ...RESERVED_THEME_IDS,
  LEGACY_MOBILE_THEME_ID,
]);
export type ThemeAppearance = "light" | "dark";

/** Product color roles shared by web CSS and native surfaces. */
