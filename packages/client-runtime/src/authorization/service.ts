...
import { assertLocalConnectionEndpoints } from "../connection/local.ts";
...
const fetchDescriptor = Effect.fn("clientRuntime.connection.local.fetchDescriptor")(function* (
  httpBaseUrl: string,
...
const make = Effect.gen(function* () {
  ...
  const authorizeBearer = Effect.fn("clientRuntime.connection.remote.authorizeBearer")(
    function* (input: {
      ...
      yield* assertLocalConnectionEndpoints(input);
