 ...
 * (`~/.claude/projects/**\/*.jsonl`, `~/.codex/sessions/**\/*.jsonl`) rather than relying on T3 Code's own
 ...
 *
 * Existing v4 Claude/Codex buckets remain valid when an app update briefly
 * overlaps a running local backend.
 */
