...
/** Desktop replacement restarts the bundled backend with the app. */
export const ServerSelfUpdateMethod = Schema.Literal("desktop-app");
export type ServerSelfUpdateMethod = typeof ServerSelfUpdateMethod.Type;

/** Updates are managed by the local desktop app. */
export const ServerSelfUpdateCapability = Schema.Literal("desktop-managed");
