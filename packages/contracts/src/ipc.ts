...
const DesktopSnapShotMode = Schema.Literals(["direct", "unavailable"]);
...
interface PreviewAnnotationElementTarget {
  id: string;
...
interface PreviewAnnotationScreenshot {
  dataUrl: string;
  width: number;
  height: number;
...
type JiraProjectPage = typeof JiraProjectPageSchema.Type;
